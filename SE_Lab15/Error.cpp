...
namespace Error {
	...
	static error errs[ERROR_MAX_ENTRY] =
	{
		ERROR_ENTRY(0, "Недопустимый код ошибки"),
		ERROR_ENTRY(0, "Системный збой"),
		...
		ERROR_ENTRY(104, "Превышена длинна входного пораметра!"),
	...
	{
		if (id < 0 || id > ERROR_MAX_ENTRY - 1) throw errs[0];
